...
$(document).ready(function(){
	...
	function window_load(){
		...
		o.street_width = $(window).height() * 7.7961019;
		$('.street').eq(1).css('left', o.street_width - 5);
		$('.street_all').css('margin-left',$(window).height() * 7.826087 * -1);
		$('.guy').css('width',o.street_width);
		$('.event_point_box').css('width',o.street_width);
		o.loading_num +=1;
		check_loading();
	}
