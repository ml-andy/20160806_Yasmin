...
(lib.Bitmap41 = function() {
	this.spriteSheet = ss["loading_ani_atlas_"];
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,542,58);
...
(lib.Brush02_mc = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:39.5,scaleX:1.6,scaleY:1.6,x:882.8,y:39.5,alpha:1},20).wait(1));
...
(lib.loading_ani = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_2.setTransform(375,707,1,1,0,0,0,139.5,65.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(50));

	// 圖層 5
	this.instance_3 = new lib.Brush03_mc();
	this.instance_3.setTransform(375,667,0.385,0.385,22.5,0,0,-561,36.4);
	...
	this.instance_4.setTransform(375.1,667.1,0.385,0.385,120,0,0,-601.8,37.9);
	...
	this.instance_5.setTransform(375.1,667.1,0.385,0.385,90,0,0,-560.7,36.4);
	...
	this.instance_6.setTransform(375,666.9,0.385,0.385,-165,0,0,-564,39.6);
	...
	this.instance_7.setTransform(375,667.1,1,1,-75,0,0,-595.3,37.5);
	...
	this.instance_8.setTransform(375,667.1,1,1,45,0,0,-601.8,38);
	...
	this.instance_9.setTransform(375.1,667,1,1,135,0,0,-560.9,36.4);
	...
	this.instance_10.setTransform(375.1,666.9,1,1,-135,0,0,-564.1,39.6);
	...
	this.instance_11.setTransform(375,667.1,1,1,-45,0,0,-595.3,37.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(50));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(610.5,1250.6,279,188.9);
